...
- **Attendance creation 500 error**: Fixed ambiguous `is_locked` column
  reference in upsert queries that caused individual attendance creation
  to fail with `SQLSTATE 42702`.
