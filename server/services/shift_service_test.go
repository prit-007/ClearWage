...
func TestShiftService_Create(t *testing.T) {
	...
	shift, err := svc.CreateShift(context.Background(), "00000000-0000-0000-0000-000000000001", "Morning Shift", "09:00", "18:00", false, 15, true)
	if err != nil {
...
func TestShiftService_List(t *testing.T) {
	...
	shifts, err := svc.ListShifts(context.Background(), "00000000-0000-0000-0000-000000000001")
	if err != nil {
...
func TestShiftService_Create_DBError(t *testing.T) {
	...
	_, err := svc.CreateShift(context.Background(), "00000000-0000-0000-0000-000000000001", "Test", "09:00", "18:00", false, 15, false)
	if err == nil {
